    ...
    return (
        <div className='w-10/12 mx-auto'>
            ...
            <div className='grid grid-cols-3 gap-14'>
                {
                    loadeDAta.map( card=> <div key={card._id} className="card   shadow-xl">
                        <figure>
                        ...
                        <div className="card-body">
                          ...
                          <p className="h-14 text-gray-600 overflow-hidden">{card.description} in <span className='badge badge-secondary font-semibold'>{card.serviceArea}</span></p>
                              </div>
                              <div>
                                  <p>{card.price}$</p>
                              </div>
