...
const Section2 = () => {
  ...
  return (
    <div className="py-10">
      <p className={`text-xl text-center ${day ? "text-white" : "text-gray-500"}`}>---How it works</p>
      
      <h1 className={`text-3xl font-semibold text-center mb-6 ${day ? "text-white" : "text-gray-500"}`}>
        Easiest way to get a service
      </h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 w-10/12 mx-auto py-5 gap-8">
        <div className="relative">
          <span className="hover:text-green-900 absolute top-[-40px] left-1/2 transform -translate-x-1/2 text-5xl text-red-700">
            <ImPlay2 />
          </span>
          <img
        ...
        <div className="my-auto space-y-8">
          <div className="flex items-start">
            ...
            <div className="ml-4">
              ...
              <p className={`text-lg ${day ? "text-white" : "text-gray-500"}`}>
